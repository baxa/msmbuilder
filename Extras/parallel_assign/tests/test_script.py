...
class test_main:
    ...
    def test_1(self):
        try:
            ...
            assignments = io.loadh(os.path.join(args.output_dir, 'Assignments.h5'))
            r_assignments = io.loadh(os.path.join(fixtures_dir(), 'Assignments.h5'))
            distances = io.loadh(os.path.join(args.output_dir, 'Assignments.h5.distances'))
            r_distances = io.loadh(os.path.join(fixtures_dir(), 'Assignments.h5.distances'))
